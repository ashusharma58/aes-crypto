...
const aes128CbcEncryptedData = Aes.encrypt('aes-128-gcm', aes128CbcCipherTextParams, aesOptions)
...
const aes128CbcPlainText = Aes.decrypt('aes-128-gcm', aes128CbcPlainTextParams, aesOptions)
console.log('aes128CbcPlainText:', aes128CbcPlainText)

if (aes128CbcPlainText.data === data) {
  console.log('Aes-128-GCM Test Passed!')
} else {
  console.log('Aes-128-GCM Test Failed!')
}
/// /////////////////////////////////////////////////////////////////////////////

// Test Aes-128-GCM with KDF ///////////////////////////////////////////////////
console.log('\n\nTesting Aes-128-GCM with KDF...')
console.log('data:', data)
console.log('masterKey:', masterKey)
const aes128CbcWithKDFCipherTextParams = { data, masterKey }
const aes128CbcWithKDFEncryptedData = Aes.encrypt('aes-128-gcm', aes128CbcWithKDFCipherTextParams, aesOptionsWihtKDF)
...
const aes128CbcWithKDFPlainText = Aes.decrypt('aes-128-gcm', aes128CbcWithKDFPlainTextParams, aesOptionsWihtKDF)
console.log('aes128CbcWithKDFPlainText:', aes128CbcWithKDFPlainText)

if (aes128CbcWithKDFPlainText.data === data) {
  console.log('Aes-128-GCM with KDF Test Passed!')
} else {
  console.log('Aes-128-GCM with KDF Test Failed!')
}
/// /////////////////////////////////////////////////////////////////////////////
...
const aes256CbcEncryptedData = Aes.encrypt('aes-256-gcm', aes256CbcCipherTextParams, aesOptions)
...
const aes256CbcPlainText = Aes.decrypt('aes-256-gcm', aes256CbcPlainTextParams, aesOptions)
...
// // Test Aes-256-GCM with KDF ///////////////////////////////////////////////////
console.log('\n\nTesting Aes-256-GCM with KDF...')
console.log('data:', data)
console.log('masterKey:', masterKey)
const aes256CbcWithKDFCipherTextParams = { data, masterKey }
const aes256CbcWithKDFEncryptedData = Aes.encrypt('aes-256-gcm', aes256CbcWithKDFCipherTextParams, aesOptionsWihtKDF)
...
const aes256CbcWithKDFPlainText = Aes.decrypt('aes-256-gcm', aes256CbcWithKDFPlainTextParams, aesOptionsWihtKDF)
console.log('aes256CbcWithKDFPlainText:', aes256CbcWithKDFPlainText)

if (aes256CbcWithKDFPlainText.data === data) {
  console.log('Aes-256-GCM with KDF Test Passed!')
} else {
  console.log('Aes-256-GCM with KDF Test Failed!')
}
// ////////////////////////////////////////////////////////////////////////////////
